...
STATUS_ORDER = [
    ...
    "SUSPENDED","COMPLETED","TERMINATED","WITHDRAWN","UNKNOWN",
]
...
fig = px.imshow(
    ...
    zmax=z95,           # remove this line if you want full range
    text_auto=True,
)
fig.update_layout(
    ...
    plot_bgcolor="white",
    paper_bgcolor="white",
    margin=dict(l=60, r=20, t=10, b=60),  # smaller top margin since no title
)
...
# if you don't want an index page, you can skip writing index.html
fig.write_html("public/phase_status_all.html", include_plotlyjs="cdn", full_html=True)

print("Wrote: public/phase_status_all.html")
